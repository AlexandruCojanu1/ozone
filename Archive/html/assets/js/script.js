...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.main-menu .navbar-collapse li a').on('click', function () {
            $('.navbar-collapse').removeClass('show');
        ...
        if ($('.slideshow-images').length) {
            ...
            $slickElementt.slick({
                ...
                asNavFor: '.features-content-slider'
            });
        }
        ...
        // ## Image Modal Functionality with Magnific Popup
        $('.expandable-image, .zoom-btn').magnificPopup({
            type: 'image',
            gallery: {
                enabled: true,
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Check if FullCalendar is available and calendar element exists
